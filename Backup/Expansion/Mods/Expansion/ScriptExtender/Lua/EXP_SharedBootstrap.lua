...
function EXP_Cleric()
	...
	dsclife.DescriptionParams = "DealDamage(LevelMapValue(DivineStrikes),Radiant);DealDamage(MainMeleeWeapon,MainMeleeWeaponDamageType)"
	...
	dsrnlightning.DescriptionParams = "DealDamage(LevelMapValue(DivineStrikes),Lightning);DealDamage(MainRangedWeapon, MainRangedWeaponDamageType)"
	...
	dsrtrickery.DescriptionParams = "DealDamage(LevelMapValue(DivineStrikes),Poison);DealDamage(MainRangedWeapon, MainRangedWeaponDamageType)"
	...
	dscdeath.DescriptionParams = "DealDamage(LevelMapValue(DivineStrikes), Necrotic);DealDamage(LevelMapValue(DivineStrikes), MainMeleeWeaponDamageType)"
...
--	Ext.Loca.UpdateTranslatedString("h19056f3bg05d1g4fe1g8a39g0cc0b302fee1","Pick the weapon you'd like to use as your principal weapon, replacing your quarterstaff. You will be able to channel your magic through it during combat.")
	...
	bladesongwm.Description = "hd8b5dde4gac64g4725gb148g8655b2421e88"
...
local EXP_FutureSubclasses

function EXP_RemoveFutureSubclasses()
    EXP_ApplyStaticData(EXP_FutureSubclasses)
end

EXP_FutureSubclasses = {
    ["Progression"] = {
        ["086676dd-3b32-4b59-88fd-501841c4dd36"] = {
            ["PassivesAdded"] = {
                ["Type"] = "overwrite",
                ["Value"] = "",
            },
        ...
        ["40e18417-c68f-4edb-9997-cc2bc5792959"] = {
            ["PassivesAdded"] = {
                ["Type"] = "overwrite",
                ["Value"] = "",
            },
        ...
        ["d2f43457-040a-4295-af42-53ca437b66e2"] = {
            ["PassivesAdded"] = {
                ["Type"] = "overwrite",
                ["Value"] = "",
            },
        ...
        ["75d33113-e954-4495-98b2-fbb5b46e80f6"] = {
            ["PassivesAdded"] = {
                ["Type"] = "overwrite",
                ["Value"] = "",
            },
		},
        ["2ddaed4b-03d4-4f1f-99d8-46bdecf56f59"] = {
            ["PassivesAdded"] = {
                ["Type"] = "remove",
                ["Value"] = "CommandUndead",
            },
