...
Ext.Osiris.RegisterListener("UsingSpell", 5, "after", function (uuid, name, _, _, _, _)
--- Ext.Utils.PrintWarning("UsingSpell",character, spell)
	if name == 'Target_CauseFear_Shadowtouched_cha' then
    ApplyStatus(uuid, "SHADOWTOUCHED_CAUSEFEAR_CHA", -1, 1)    
    end
end)
...
Ext.Osiris.RegisterListener("UsingSpell", 5, "after", function (uuid, name, _, _, _, _)
--- Ext.Utils.PrintWarning("UsingSpell",character, spell)
	if name == 'Target_CauseFear_Shadowtouched_int' then
    ApplyStatus(uuid, "SHADOWTOUCHED_CAUSEFEAR_INT", -1, 1)    
    end
end)
...
Ext.Osiris.RegisterListener("UsingSpell", 5, "after", function (uuid, name, _, _, _, _)
--- Ext.Utils.PrintWarning("UsingSpell",character, spell)
	if name == 'Target_CauseFear_Shadowtouched_wis' then
    ApplyStatus(uuid, "SHADOWTOUCHED_CAUSEFEAR_WIS", -1, 1)    
    end
end)
